...
![Default Default Dark Colours](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/DefaultDefaultDarkColours.png)

'Default' theme colours in light mode with Default Obsidian theme:

![Default Default Light Colours](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/DefaultDefaultLightColours.png)

'Default' theme colours in dark mode with [Obsidianite](https://github.com/bennyxguo/Obsidian-Obsidianite) theme:

![Default Obsidianite Dark Colours](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/DefaultObsidianiteDarkColours.png)

'Solarized' theme colours in dark mode with Default Obsidian theme:

![Solarized Default Dark Colours](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/SolarizedDefaultDarkColours.png)
...
![Title Short](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/TitleShort.png)

` ```cpp title:"long filename.cpp" `

![Title Long](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/TitleLong.png)
...
![Fold](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/Fold.png)

` ```cpp fold:"This is collapsed" `

![Fold Placeholder](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/FoldPlaceholder.png)

Clicking on header  

![Collapse](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/Collapse.gif)
...
![Default Highlight](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/DefaultHighlight.png)

Highlights can be set to also highlight line numbers as well as the code in settings.

Example:  

![Default Highlight Gutter](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/DefaultHighlightGutter.png)
...
![Default Highlight Gradient](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/DefaultHighlightGradient.png)
...
![Alternative Highlights](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/AlternativeHighlights.png)

Corresponding settings:

![Alternative Highlights](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/AlternativeHighlightsSettings.png)
...
![Unwrap True](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/UnwrapTrue.gif)

` ```python unwrap:false ` or ` ```python wrap `  

![Unwrap False](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/UnwrapFalse.png)

` ```python unwrap:inactive `  

![Unwrap Inactive](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/UnwrapInactive.gif)
...
![Ignore](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/Ignore.png)

`code-styler-ignore: true`  

![Ignore Metadata](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/IgnoreMetadata.png)
...
![Language Border](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/LanguageBorder.png)
...
- No header  
    ...
    ![Header None](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/HeaderNone.png)
    
- Header with fold only  
    
    ![Header Fold](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/HeaderFold.png)
    
- Header with codeblock language only  
    
    ![Header Language](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/HeaderLanguage.png)
    
- Header with codeblock language and title as well  
    
    ![Header Language Title](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/HeaderLanguageTitle.png)
    
- Header with codeblock language, title and icon as well  
    
    ![Header Language Title Icon](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/HeaderLanguageTitleIcon.png)
...
![Active Codeblock Highlight](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/ActiveCodeblockHighlight.png)

![Active Line Number Indicator](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/ActiveLineNumberIndicator.png)

![Active Editor Highlight](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/ActiveEditorHighlight.png)
...
![Inline Code Highlighted](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/InlineCodeHighlighted.png)
...
![Inline Code Highlighted Icon](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/InlineCodeHighlightedIcon.png)

`{python title:'Inline If'} 'result if true'.method() if 1 else result_if_false.property`  

![Inline Code Highlighted Title](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/InlineCodeHighlightedTitle.png)

`{python title:'Inline If' icon} 'result if true'.method() if 1 else result_if_false.property`  

![Inline Code Highlighted Title Icon](https://raw.githubusercontent.com/mayurankv/Obsidian-Code-Styler/HEAD/images/InlineCodeHighlightedTitleIcon.png)
...
You can set the local path or remote link using the parameters: `file`, `path`, `link`, and `filePath`. Local paths should be set as relative paths (i.e. `./path/from/current/folder`), absolute paths starting from the root vault - indicated by `@/` (i.e. `@/file.py`=`.../vaultParent/file.py`), or markdown links (i.e. `[[file.py|file.py]]`). Remote paths, should be set using a link to the file from the relevant site, i.e. `link: https://github.com/mayurankv/Obsidian-Code-Styler/blob/main/README.md`.
...
See the roadmap at [Roadmap Discussion](app://obsidian.md/discussions/8).
...
All contributions are welcome, just create a merge request. The bullet points in the [roadmap](app://obsidian.md/discussions/8) are a good place to start!
