...
Refer to the [Organizing Code with Functions](https://p5js.org/tutorials/organizing-code-with-functions/) tutorial to review the syntax and use of custom functions. 
